            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    ...
                    <div class="row mb-5 site-section">
                        <div class="col-12 ">
                            <h2 class="site-section-heading text-center text-white">Choose Upcoming Activity</h2><br /><br />
                            <form method="POST" action="up.php" enctype="multipart/form-data">
                                <div class="wrap-input100 validate-input" align="center">
                                    <input class="input100" type="text" name="name" placeholder="Name of Activity">
                                ...
                                <div class="wrap-input100 validate-input" required>
                                    <input type="file" name="fileToUpload" value="" required /><br />
                                    <span class="focus-input100"></span>
                                </div>
